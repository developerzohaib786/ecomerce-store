...
const Footer = () => {
  return (
    <footer className="w-full border-t border-[#FF5F1F]/30 bg-white text-[#FF5F1F]">
      ...
      {/* Bottom section */}
      <div className="text-center py-4 text-sm text-black space-y-1">
        <p>
          ...
          <a
            ...
            className="underline hover:text-[#e34f14] text-[#FF5F1F]/80 transition-colors"
          >
            developerzohaib786
          </a>
        </p>
        <p>© {new Date().getFullYear()} RedditRevs. All rights reserved.</p>
      </div>
    </footer>
  );
};
